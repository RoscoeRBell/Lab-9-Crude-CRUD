...
$conn = new mysqli('localhost', 'roscoe', 'roscoepassword', 'employees' );
...
?>
<p>For more information on connecting PHP to MySQL click here: <a href="https://www.php.net/manual/en/book.mysqli.php">mysqli</a></p>
</body>
</html>
